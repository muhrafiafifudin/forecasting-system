...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center me-3">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Master Departemen
            <!--begin::Separator-->
                    ...
                    <div class="card-body py-3 pt-10">
                        ...
                        <div class="table-responsive">
                                    ...
                                    @foreach ($departments->data as $department)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('department.destroy', \Crypt::encrypt($department->id)) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')

                                                    <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#modal_department_{{ $department->id }}">
                            ...
                            @foreach ($departments->data as $department)
                                ...
                                <div class="modal fade" id="modal_department_{{ $department->id }}" tabindex="-1" aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                                                ...
                                                <div class="mb-13 text-center">
                                                    ...
                                                    <div class="text-gray-400 fw-bold fs-5">Form Untuk Mengubah Data Departemen</div>
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Scroll-->
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_form" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                                    <!--begin:Form-->
                                                    <form class="form" action="{{ route('department.update', \Crypt::encrypt($department->id)) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        <div class="d-flex flex-column mb-5 fv-row">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid" placeholder="Masukkan Nama Barang" name="item" value="{{ $department->department }}" />
                                                        </div>
                                                        <!--end::Input group-->
